package com.china.beijing.feature;
...
public class SimpleMailSender {
     ...
     * @return: void
     */
    public static void sendEmail(final MailSenderInfo mailInfo) throws Exception {
        ...
        Session session = Session.getInstance(props, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("xxx@qq.com","你的授权码");
            }
        });
